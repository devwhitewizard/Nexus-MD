...
if (sequelize) {
    SettingsDB = sequelize.define('settings', {
        ...
        footer: { type: DataTypes.STRING, defaultValue: '© Nexus-MD • Channel: https://whatsapp.com/channel/0029VbD62UY7IUYU6cftzu02' },
        ...
        packName: { type: DataTypes.STRING, defaultValue: 'Nexus-MD' },
